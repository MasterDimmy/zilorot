// Package zilorot provides a rolling logger with zipped storing of data.
// Based on  https://github.com/natefinch/lumberjack
package zilorot
...
// is less than MaxSize megabytes, zilorot will open and append to that file.
...
type Logger struct {
	...
	// in the same directory.  It uses <processname>-zlt.log in
	// os.TempDir() if empty.
...
func (l *Logger) oldLogFiles() ([]logInfo, error) {
	...
	for _, f := range files {
		...
		// by zilorot, and therefore it's not a backup file.
	}
